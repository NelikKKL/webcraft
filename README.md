...
**Статус: этап 2 — GL/ввод мост (готово) + AWT/ImageIO/ресурсы мост
(готово) + смоук-тест.** Настоящий `Minecraft.java` (519 файлов
оригинального decomp) **ещё не скопирован в проект** — вся необходимая
инфраструктура для его интеграции готова, само копирование дерева и
точечные патчи (список в `PATCHES.md`) — следующая сессия, см. TODO.md
раздел "СЛЕДУЮЩАЯ СЕССИЯ НАЧИНАЕТ ЗДЕСЬ".
